                ...
                <div class="card-header">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-md-auto py-2 py-md-0">
                      <a href="./users/add-admin.php" class="btn btn-label-info btn-round me-2"><i class="fa fa-plus"></i> Add Admin</a>
                      <a
                        class="btn btn-primary btn-round ms-auto"
                        href="./users/add-user.php">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="form-button-action">
                                <a
                                  type="button"
                                  href=" ./users/edit-user.php?id=<?= $u['id'] ?>"
