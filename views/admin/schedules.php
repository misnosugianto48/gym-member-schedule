...
<body>
                      ...
                      <tbody>
                        ...
                        <?php foreach ($schedules as $s) : ?>
                          <tr>
                            ...
                            <td><?= date('h:i A', strtotime($s['start_at'])) . ' - ' . date('h:i A', strtotime($s['end_at'])) ?></td>
                            ...
                            <td>
                              <div class="form-button-action">
                                <a
                                  type="button"
                                  href=" ./schedules/edit.php?id=<?= $s['id'] ?>"
  ...
  <script>
    ...
    $(document).on('click', '.delete-btn', function(e) {
      e.preventDefault();
      const scheId = $(this).data('id');


      swal({
        title: 'Are you sure?',
        text: "This shcedule will be permanently deleted!",
        type: 'warning',
        buttons: {
          cancel: {
            visible: true,
        ...
        if (willDelete) {
          window.location.href = `./schedules/delete-schedule.php?id=${scheId}`;
        }
      });
    });
  </script>
