...
$scheId = $_GET['id'];
$schedule = $scheduleController->getScheduleById($scheId);
// var_dump($schedule);
        ...
        <div class="page-inner">
          <div class="page-header">
            ...
            <ul class="breadcrumbs mb-3">
              ...
              <li class="nav-item">
                <a href="./add.php">Edit Schedules</a>
              </li>
            </ul>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <div class="card-title">Form Edit Schedules</div>
                </div>
                <div class="card-body">
                  <div class="row">
                      ...
                      <form action="" role="form" class="form-action" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="mentor_id" name="mentor_id">
                            <option value="<?= $schedule['mentor_id'] ?>"><?= $schedule['fullname'] ?></option>
                    ...
                    <div class="col-md-6 col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="time" class="form-control" id="end_at" name="end_at" value="<?= $schedule['end_at']; ?>" />
