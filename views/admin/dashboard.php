...
$dashboardStats = $indexController->getDashboardStats();
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col col-stats ml-3 ml-sm-0">
                      <div class="numbers">
                        ...
                        <h4 class="card-title"><?= $dashboardStats['total_members'] ?></h4>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col col-stats ml-3 ml-sm-0">
                      <div class="numbers">
                        ...
                        <h4 class="card-title"><?= $dashboardStats['total_memberships'] ?></h4>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col col-stats ml-3 ml-sm-0">
                      <div class="numbers">
                        ...
                        <h4 class="card-title"><?= $dashboardStats['total_mentors'] ?></h4>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col col-stats ml-3 ml-sm-0">
                      <div class="numbers">
                        ...
                        <h4 class="card-title"><?= $dashboardStats['total_bookings'] ?></h4>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="card-list">
                    <?php foreach ($dashboardStats['recent_members'] as $member): ?>
                      <div class="item-list">
                        <div class="avatar">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <?php foreach ($dashboardStats['transactions'] as $transaction): ?>
                          <tr>
